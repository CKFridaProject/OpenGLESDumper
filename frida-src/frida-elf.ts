...
const fopenImpl  = api.fopen;//initializeNativeFunction('fopen', 'pointer', ['pointer', 'pointer']);
const fcloseImpl = api.fclose;//initializeNativeFunction('fclose', 'int', ['pointer']);
const fseekImpl  = api.fseek;//initializeNativeFunction('fseek', 'int', ['pointer', 'int', 'int']);
const freadImpl  = api.fread;//initializeNativeFunction('fread', 'uint32', ['pointer', 'int', 'int', 'pointer']);
...
//
//function initializeNativeFunction(fname: string, retType:NativeFunctionReturnType, argTypes:NativeFunctionArgumentType[]): NativePointer | null {
